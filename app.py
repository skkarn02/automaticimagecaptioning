...
if bool(image_file)==True :
    ...
    st.write("[link](https://drive.google.com/file/d/1pYzE-EoPBybg3dRKrZwClP8nejyh-U2D/view?usp=sharing)")
    st.write("[link](https://drive.google.com/file/d/1vyqnOlHmXOQXMPHQFtjWu5oFsjWNgus9/view?usp=sharing)")
    st.text("")
    st.text("")
