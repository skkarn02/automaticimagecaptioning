...
def preprocess_image(img) :
    img1=Image.open(img)
    img = img1.resize((299,299),Image.ANTIALIAS)
    img=np.expand_dims(img,axis=0)
    img=preprocess_input(img)
    feature_vector = im.predict(img)
...
#Load model 
ic_model=load_model('model50.h5')
...
if bool(image_file)==True :
    ...
    ran_imageid=['416960865_048fd3f294','1392272228_cf104086e6','2599444370_9e40103027','3384314832_dffc944152','3482974845_db4f16befa','3558370311_5734a15890','542179694_e170e9e465','2739331794_4ae78f69a0']
